                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-black text-slate-900 flex items-center gap-3 tracking-tight">
                                <span className="p-2.5 bg-teal-100 text-teal-700 rounded-2xl text-xl">♻️</span>
                                Quản Lý Lịch Sử Refill
                            </h1>
                            <p className="text-slate-500 text-xs md:text-sm mt-1">
                                Tra cứu toàn bộ giao dịch refill, lọc theo khoảng thời gian và theo dõi số lượt tái nạp
                            </p>
                        </div>
                    </div>
                </div>
